    ...
    const fetchStatistics = async () => {
      ...
      try {
        ...
        const mappedStats: DashboardStats = {
          ...
          totalOrders: revenueReport?.totalOrders || (data.ordersByStatus.COMPLETED + data.ordersByStatus.DELIVERED +
                       data.ordersByStatus.PENDING + data.ordersByStatus.PROCESSING +
                       data.ordersByStatus.CONFIRMED + data.ordersByStatus.SHIPPING),
